...
.PHONY: assets fetch-openmoji all-lines all-gray lines divination animals-simple weather-simple materials-simple science-simple outliers-simple brushify-pua font check check-pua check-catalog contact-pua review-pua check-svg check-sumi-e
