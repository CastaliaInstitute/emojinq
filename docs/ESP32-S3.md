...
pass removes fills and decorative echo contours, then applies deterministic
single-stroke width variation without rasterizing. The tools intentionally do not emit
