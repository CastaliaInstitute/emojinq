...
3. Add a dark primary contour and a restrained broken-pencil character.
...
6. When the line-art treatment is preferred, run `make lines`; this removes fills and decorative echo contours, then keeps one roughened stroke per piece of geometry with deterministic calligraphic width variation, without rasterizing or flattening the vector geometry.
